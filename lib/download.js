...
import { configuredBuildUrl, getCurrentBuild } from "./build.js";
...
export function isDownloadConfigured() {
  return Boolean(configuredBuildUrl());
}

export async function chunkBuildUrl() {
  return (await getCurrentBuild()).url;
}
